  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden">
      ...
      <div className="pointer-events-none fixed inset-0 z-0">
        ...
        <div className="absolute left-0 top-1/2 h-[500px] w-[500px] rounded-full bg-cyber-blue/5 blur-[150px]" />
        <div className="absolute right-0 top-1/3 h-[450px] w-[450px] rounded-full bg-accent/7 blur-[130px]" />
        <div className="absolute -left-20 bottom-1/4 h-[400px] w-[400px] rounded-full bg-cyber-blue/10 blur-[120px]" />
