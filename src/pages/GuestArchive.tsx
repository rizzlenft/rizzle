...
const guestData = [
  ...
  "Antara", "Badger", "Barely Sociable", "Batsoupyum", "Beeple", "Ben Lakoff",
  "BigHeadClub", "BigPappa", "Bitange", "BitBoy",
  ...
  "Courtyard.io", "Crayz", "CryptoBarista", "CryptoChrome", "CryptoGarga", "Cryptograph",
  ...
  "HeyMint", "Hop Exchange", "Hugh McDonaugh", "HYPEBEAST", "Illestrater", "Isaac Wright",
  ...
  "Nouns DAO", "NTmre", "OnChainChain", "Ovie Faruq", "Osinachi", "OSF",
  "Pankaj Patel", "PaperclipMax", "Patrick Mahomes", "Pepsi",
